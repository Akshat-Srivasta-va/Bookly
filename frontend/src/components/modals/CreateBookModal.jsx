...
const CreateBookModal = ({ isOpen, onClose, onBookCreated }) => {
  ...
  const handleGenerateOutLine = async () => {
    if (!bookTitle || !numChapters) {
      toast.error("Please provide a book title and number and number of chapters.")
      return;
    }
    ...
    try {
      ...
      setStep(2);
      toast.success("Outline generated! Review and edit chappters.");
    } catch (error) {
      toast.error(
      ...
      {step === 1 && (
        <div className="space-y-5">
          <div className="flex items-center gap-2 mb-6">
            ...
            <div className="flex items-center justify-center w-8 h-8 rounded-full bg-gray-400 text-sm font-semibold">
              2
            </div>
          </div>
          <InputField
      ...
      {step === 2 && (
        <div className="space-y-5">
          ...
          <div className="flex items-center gap-2 mb-6">
            ...
            <div className="flex items-center justify-center w-8 h-8 rounded-full bg-violet-100 text-violet-600 text-sm font-semibold">2</div>
          </div>
              ...
              chapters.map((chapter, index) => {
                <div key={index} className="group p-4 border border-gray-200 rounded-xl hover:border-gray-300 hover:shadow-sm transition-all bg-white">
                  ...
                  <textarea
                    ...
                    placeholder="Brief description of what this chapters covers..."
                    rows={2}
