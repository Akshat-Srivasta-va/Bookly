    ...
    <div className="flex h-[calc(100vh-64px)] bg-white text-gray-900">
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex justify-between items-center mt-16 pt-8 border-t border-gray-200">
          ...
          className="flex items-center gap-2 px-4 py-2 bg-gray-100 hover:bg-200 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
