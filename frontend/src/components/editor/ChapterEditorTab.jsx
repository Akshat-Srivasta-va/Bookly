    ...
    >
      ...
      <div className="border-b border-gray-100 bg-white">
        <div className="px-8 py-6">
          <div className="flex flex-col md:flex-col md:items-center gap-4 md:gap-0 justify-between">
            <div>
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="hover:bg-gray-100 rounded-lg transition-colors text-gray-600"
      ...
      <div className="flex-1 overflow-hidden">
        <div className="h-full bg-white px-8 py-6">
          ...
          <div className="flex-1 min-h-0">
            {isPreviewMode ? (
              <div className="h-full border-gray-200 rounded-lg overflow-y-auto">
                <div className="bg-gray-50 px-4 py-3 border-b border-gray-200">
                  <div className="flex items-center gap-2 text-sm texxt-gray-600">
                ...
                <div className="p-8">
                  <h1 className="text-3xl font-bold mb-6 text-gray-900">
                    {currentChapter.title || "Untitles Chapter"}
                  </h1>
                  <div
