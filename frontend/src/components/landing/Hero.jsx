        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="max-w-xl space-y-8">
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-6xl font-bold text-gray-900 leading-tight tracking-tight">
              Create Stunning
              <span className="block mt-2 bg-gradient-to-r from-violet-600 to-violet-600 bg-clip-text text-transparent">Ebooks in minutes</span>
            </h1>
