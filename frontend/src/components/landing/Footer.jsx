import { BookOpen, Instagram, Linkedin, Github, Link } from "lucide-react";
  ...
  return (
    <footer className="relative bg-gradient-to-br from-gray-950 via-gray-950 to-violet-950 text-white overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
        <div className="py-16 grid grid-cols-1 md:grid-cols-1 gap-12">
          {/* Brand Section */}
          <div className="md:col-span-5 space-x-y">
